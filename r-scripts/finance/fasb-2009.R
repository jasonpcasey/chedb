...
spec1 <- "U:/Data/EX/z_external_data/IPEDS_Finance/2008_09/Final/f0809_f2_rv.csv"
spec2 <- "U:/Data/EX/z_external_data/IPEDS_Finance/2008_09/Final/flags2009.csv"
...
dat$f2d010 <- nullSub(dat$f2d01) - (nullSub(dat$f2d012) + nullSub(dat$f2d013) + nullSub(dat$f2d014))
dat$f2d020 <- nullSub(dat$f2d02) - (nullSub(dat$f2d022) + nullSub(dat$f2d023) + nullSub(dat$f2d024))
dat$f2d030 <- nullSub(dat$f2d03) - (nullSub(dat$f2d032) + nullSub(dat$f2d033) + nullSub(dat$f2d034))
dat$f2d040 <- nullSub(dat$f2d04) - (nullSub(dat$f2d042) + nullSub(dat$f2d043) + nullSub(dat$f2d044))
dat$f2d050 <- nullSub(dat$f2d05) - (nullSub(dat$f2d052) + nullSub(dat$f2d053) + nullSub(dat$f2d054))
dat$f2d060 <- nullSub(dat$f2d06) - (nullSub(dat$f2d062) + nullSub(dat$f2d063) + nullSub(dat$f2d064))
dat$f2d070 <- nullSub(dat$f2d07) - (nullSub(dat$f2d072) + nullSub(dat$f2d073) + nullSub(dat$f2d074))
dat$f2d080 <- nullSub(dat$f2d08) - (nullSub(dat$f2d082) + nullSub(dat$f2d083) + nullSub(dat$f2d084))
dat$f2d090 <- nullSub(dat$f2d09) - (nullSub(dat$f2d092) + nullSub(dat$f2d093) + nullSub(dat$f2d094))
dat$f2d100 <- nullSub(dat$f2d10) - (nullSub(dat$f2d102) + nullSub(dat$f2d103) + nullSub(dat$f2d104))
dat$f2d110 <- nullSub(dat$f2d11) - nullSub(dat$f2d112)
dat$f2d120 <- nullSub(dat$f2d12) - nullSub(dat$f2d122)
dat$f2d130 <- nullSub(dat$f2d13) - nullSub(dat$f2d132)
dat$f2d140 <- nullSub(dat$f2d14) - (nullSub(dat$f2d142) + nullSub(dat$f2d143) + nullSub(dat$f2d144))
dat$f2d150 <- nullSub(dat$f2d15) - (nullSub(dat$f2d152) + nullSub(dat$f2d153) + nullSub(dat$f2d154))

revenues <- melt(data=dat,
                 id=c('unitid',
                      'YearId'),
                 measure.vars=c('f2d012', 'f2d013', 'f2d014','f2d010',
                                'f2d022', 'f2d023', 'f2d024','f2d020',
                                'f2d032', 'f2d033', 'f2d034','f2d030',
                                'f2d042', 'f2d043', 'f2d044','f2d040',
                                'f2d052', 'f2d053', 'f2d054','f2d050',
                                'f2d062', 'f2d063', 'f2d064','f2d060',
                                'f2d072', 'f2d073', 'f2d074','f2d070',
                                'f2d082a', 'f2d083a', 'f2d084a', 
                                'f2d082b', 'f2d083b', 'f2d084b','f2d080',
                                'f2d092', 'f2d093', 'f2d094','f2d090',
                                'f2d102', 'f2d103', 'f2d104','f2d100',
                                'f2d112', 'f2d110', 'f2d122', 'f2d120',
                                'f2d132','f2d130',
                                'f2d142', 'f2d143', 'f2d144','f2d140',
                                'f2d152', 'f2d153', 'f2d154','f2d150',
                                'f2d173', 'f2d174'),
                 variable.name='field',
                 value.name='Revenue')
