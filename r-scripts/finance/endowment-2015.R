...
spec1 <- "U:/Data/EX/z_external_data/IPEDS_Finance/2014_15/Provisional/f1415_f2.csv"
spec2 <- "U:/Data/EX/z_external_data/IPEDS_Finance/2014_15/Provisional/f1415_f1a.csv"
outfile <- "C:/Temp/end_dat2015.csv"
