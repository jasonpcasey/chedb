...
# Create Date: 19MAY2015
# Description: Reader script for IPEDS Completions, AY2004-2005
# Notes:
...
infile <- "http://nces.ed.gov/ipeds/datacenter/data/C2005_A.zip"
outfile <- "output-data/completions/c_2005_dat.csv"
...
# Read the data
dat <- read.table(file=unz(temp, 'c2005_a.csv'),
                  header=TRUE,
                  sep=",",
                  quote="\"",
                  skip=0,
