...
# Description: Reader script for IPEDS Completions, AY2000-2001
# Notes:
...
infile <- "http://nces.ed.gov/ipeds/datacenter/data/C2001_A.zip"
outfile <- "output-data/completions/c_2001_dat.csv"
...
# Read the data
dat <- read.table(file=unz(temp, 'c2001_a.csv'),
                  header=TRUE,
                  sep=",",
                  quote="\"",
