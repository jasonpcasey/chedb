...
# Description: Reader script for IPEDS Completions, AY2003-2004
# Notes:
...
infile <- "http://nces.ed.gov/ipeds/datacenter/data/C2004_A.zip"
outfile <- "output-data/completions/c_2004_dat.csv"
...
# Read the data
dat <- read.table(file=unz(temp, 'c2004_a.csv'),
                  header=TRUE,
                  sep=",",
                  quote="\"",
                  skip=0,
