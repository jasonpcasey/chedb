...
# Description: Reader script for IPEDS Completions, AY2002-2003
# Notes:
...
infile <- "http://nces.ed.gov/ipeds/datacenter/data/C2003_A.zip"
outfile <- "output-data/completions/c_2003_dat.csv"
...
# Read the data
dat <- read.table(file=unz(temp, 'c2003_a.csv'),
                  header=TRUE,
                  sep=",",
                  quote="\"",
                  skip=0,
